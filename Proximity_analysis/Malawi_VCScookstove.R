...
#malawi 
avoided_def_files <- c("KMLfile/VCS_REDD/Africa/1532.kml")

cookstove_files <- c("KMLfile/Cookstove_VCS/Africa/2342.kml",
                     "KMLfile/Cookstove_VCS/Africa/2372.kml",
                     "KMLfile/Cookstove_VCS/Africa/2711.kml",
                     "KMLfile/Cookstove_VCS/Africa/2886.kml")
