...
#cambodia
avoided_def_files <- c("KMLfile/VCS_REDD/Asia/1398.kml")


cookstove_files <- c("KMLfile/Cookstove_VCS/Asia/3116.kml",
                     "KMLfile/Cookstove_VCS/Asia/2925.kml",
                     "KMLfile/Cookstove_VCS/Asia/2409.kml")
