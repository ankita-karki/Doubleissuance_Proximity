...
cookstove_paths <- c("C:/Users/karki/Documents/Thesis/Samplingsurvey/Africa/2342/All_2342.shp")
 
##########
cookstove_paths <- c("C:/Users/karki/Documents/Thesis/Samplingsurvey/Africa/2342/All_2342_monitor.kml",
                     "C:/Users/karki/Documents/Thesis/Samplingsurvey/Africa/2372/Allm_2372.kml")

#mozambique 

avoided_def_files <- c("KML file/VCS_REDD/Africa/902.kml")

cookstove_paths <- c("C:/Users/karki/Documents/Thesis/Samplingsurvey/Africa/2351/Union_2351.kml")
...
avoided_def_files <- c("KML file/VCS_REDD/Africa/1168.kml")

avoided_def_files <- c("KML file/VCS_REDD/Africa/1202.kml")

avoided_def_files <- c("KML file/VCS_REDD/Africa/1532.kml")

avoided_def_files <- c("KML file/VCS_REDD/Africa/1775.kml")
#####################################################
avoided_def_files <- c("KML file/VCS_REDD/Africa/902.kml",
                       "KML file/VCS_REDD/Africa/1168.kml",
                       "KML file/VCS_REDD/Africa/1202.kml",
                       "KML file/VCS_REDD/Africa/1532.kml",
                       "KML file/VCS_REDD/Africa/1775.kml")
########################################################
#zimbabwe 

cookstove_paths <- c("C:/Users/karki/Documents/Thesis/Samplingsurvey/Africa/2341/D_2341.kml")
...
buffer_map <- buffer_map %>%
  addRasterImage(forest_cover_agg, 
                 colors = viridis::viridis(256),
                 opacity = 0.8, 
                 group = "Forest Cover Density")
...
buffer_map <- buffer_map %>%
  addPolygons(data = all_avoided_def_sf,
              fillColor = "#929291" , # Fill color for avoided deforestation projects
              color = "black", # Border color for avoided deforestation projects
              weight = 2,
...
# <- colorFactor(viridis_pal(option = "D")(length(unique(all_avoided_def_sf$filename))), all_avoided_def_sf$filename)
# Initialize the leaflet map with OpenStreetMap tiles
buffer_map <- leaflet() %>%
  addProviderTiles(providers$CartoDB.Positron)
...
###################
#Forestcover 
forest_cover_sf <- rast("C:/Users/karki/Documents/Thesis/Forestcover/New folder/ForestCover2022Africa2.tif")

print(forest_cover_sf)
...
crop_extent <- extent(11.668473, 48.037004, -46.981379, 5.061166)
...
write.csv(results_list, "overlapping_zambia.csv", row.names = FALSE)
...
# Save the extracted data to a CSV file
write.csv(results_list, "overlapping_zambia1.csv", row.names = FALSE)
#####################
